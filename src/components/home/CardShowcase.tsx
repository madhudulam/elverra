  ...
  return (
    <section className="py-16 bg-gradient-to-br from-purple-50 to-blue-50">
      <div className="container mx-auto px-4">
        ...
        <div class="cards">
        <div class="flex justify-center" style="background-repeat: no-repeat; background: url(https://tklwdscpbddieykqfbdy.supabase.co/storage/v1/object/sign/elverra/essential.png);">
</div>

<div class="flex justify-center" style="background-repeat: no-repeat; background: url(https://tklwdscpbddieykqfbdy.supabase.co/storage/v1/object/sign/elverra/premium.png);">
</div>

<div class="flex justify-center" style="background-repeat: no-repeat; background: url(https://tklwdscpbddieykqfbdy.supabase.co/storage/v1/object/sign/elverra/elite.png);">
</div>
        </div>
